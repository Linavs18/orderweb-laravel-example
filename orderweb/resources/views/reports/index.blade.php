    ...
    <div class="row">
      ...
      <div class="row">
        <div class="col-lg-12 mb-4">
            <div class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Reporte órdenes por rango de fechas</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('reports.orders_date') }}" method="POST">
                        ...
                        <div class="row form-group">
                            <div class="col-lg-3">
                                <label for="start_date">Fecha de legalización desde:</label>
                            </div>
                            <div class="col-lg-2">                                
                                <input type="date" name="start_date" id="start_date" class="form-control" required>                                
                            </div>
                            <div class="col-lg-3">
                                <label for="end_date">Fecha de legalización hasta:</label>
                            </div>
                            <div class="col-lg-2">
